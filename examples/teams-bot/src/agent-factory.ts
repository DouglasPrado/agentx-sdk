 ...
 * Uses a singleton — one agent handles all Teams conversations.
 * Each conversation is isolated via threadId = conversation.id.
 */
export async function getAgent(): Promise<Agent> {
  ...
  agent = Agent.create({
    ...
    systemPrompt: `You are Albert, a helpful Microsoft Teams assistant for managing businesses on the Albert platform.
